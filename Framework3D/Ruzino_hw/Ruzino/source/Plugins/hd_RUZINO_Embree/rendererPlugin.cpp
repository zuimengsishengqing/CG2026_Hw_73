...
{
    HdRendererPluginRegistry::Define<Hd_RUZINO_Embree_RendererPlugin>();
}
...
HdRenderDelegate* Hd_RUZINO_Embree_RendererPlugin::CreateRenderDelegate()
{
...
bool Hd_RUZINO_Embree_RendererPlugin::IsSupported(bool /* gpuEnabled */) const
{
