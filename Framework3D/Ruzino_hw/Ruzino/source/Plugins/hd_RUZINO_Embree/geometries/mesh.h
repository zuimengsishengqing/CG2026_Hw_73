...
class Hd_RUZINO_Mesh final : public HdMesh {
   ...
   private:
    ...
    Hd_RUZINO_PrototypeContext* _GetPrototypeContext();
    Hd_RUZINO_InstanceContext* _GetInstanceContext(RTCScene scene, size_t i);
    ...
    Hd_RUZINO_RTCBufferAllocator _embreeBufferAllocator;
