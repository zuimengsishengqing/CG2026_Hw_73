...
class Canvas : public Widget
{
   public:
    ...
    unsigned char get_color_r() const { return color_[0]; }
    unsigned char get_color_g() const { return color_[1]; }
    unsigned char get_color_b() const { return color_[2]; }
    
    // Line thickness functions
