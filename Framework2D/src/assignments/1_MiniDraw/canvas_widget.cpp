...
void Canvas::set_color(unsigned char r, unsigned char g, unsigned char b)
{
    color_[0] = r;
    color_[1] = g;
    color_[2] = b;
...
void Canvas::draw_shapes()
{
    Shape::Config s = { 
        ...
        .line_color = { color_[0], color_[1], color_[2], 255 },
...
void Canvas::mouse_click_event()
{
    ...
    if(shape_type_ == kFreehand){
        ...
        if(!current_shape_){
            ...
            current_shape_->set_color(color_[0], color_[1], color_[2]);
            current_shape_->set_line_thickness(line_thickness_);
