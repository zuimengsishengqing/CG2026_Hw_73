...
Hd_RUZINO_RenderBufferGL::~Hd_RUZINO_RenderBufferGL() = default;
...
/*virtual*/
void Hd_RUZINO_RenderBufferGL::_Deallocate()
{
...
/*static*/
HdFormat Hd_RUZINO_RenderBufferGL::_GetSampleFormat(HdFormat format)
{
...
GLenum Hd_RUZINO_RenderBufferGL::_GetGLFormat(HdFormat hd_format)
{
    switch (hd_format) {
...
GLenum Hd_RUZINO_RenderBufferGL::_GetGLType(HdFormat hd_format)
{
    switch (hd_format) {
        case HdFormatInvalid:
        case HdFormatUNorm8:
...
GLsizei Hd_RUZINO_RenderBufferGL::GetbufSize()
{
...
void Hd_RUZINO_RenderBufferGL::Unmap()
{
    _mappers--;
}

/*virtual*/
void Hd_RUZINO_RenderBufferGL::Resolve()
{
}
