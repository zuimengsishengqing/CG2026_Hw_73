...
///
/// Hd_RUZINO_ implements instancing by adding prototype geometry to the BVH
/// multiple times within Hd_RUZINO_Mesh::Sync(). The only instance-varying
/// attribute that Hd_RUZINO_ supports is transform, so the natural
