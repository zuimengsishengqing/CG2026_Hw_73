...
void LightShaderNodeSlang::initialize(
    ...
    GenContext& context)
{
    ...
    if (_inlined) {
        throw ExceptionShaderGenError(
            "Light shaders doesn't support inlined implementations'");
    }
...
void LightShaderNodeSlang::createVariables(
    const ShaderNode&,
    GenContext& context,
    Shader& shader) const
{
...
void LightShaderNodeSlang::emitFunctionCall(
    const ShaderNode&,
    GenContext& context,
