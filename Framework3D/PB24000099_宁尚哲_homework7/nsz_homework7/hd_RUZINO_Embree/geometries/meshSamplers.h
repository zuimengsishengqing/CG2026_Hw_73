...
using namespace pxr;
/// \class Hd_RUZINO_RTCBufferAllocator
///
...
class Hd_RUZINO_RTCBufferAllocator {
   public:
    ...
    Hd_RUZINO_RTCBufferAllocator() : _bitset(0)
    {
    }
...
// ----------------------------------------------------------------------
// The classes below implement the Hd_RUZINO_PrimvarSampler interface for
...
/// \class Hd_RUZINO_ConstantSampler
///
/// This class implements the Hd_RUZINO_PrimvarSampler interface for primvars
...
class Hd_RUZINO_ConstantSampler : public Hd_RUZINO_PrimvarSampler {
   public:
    /// Constructor.
    /// \param name The name of the primvar.
    /// \param value The buffer data for the primvar.
    Hd_RUZINO_ConstantSampler(const TfToken& name, const VtValue& value)
        : _buffer(name, value),
          _sampler(_buffer)
    {
    }
   ...
   private:
    ...
    const Hd_RUZINO_BufferSampler _sampler;
};

/// \class Hd_RUZINO_UniformSampler
///
/// This class implements the Hd_RUZINO_PrimvarSampler interface for primvars
/// with "uniform" interpolation mode. This means that the buffer has one
/// item per authored face. For unrefined meshes, Hd_RUZINO_ will convert
...
class Hd_RUZINO_UniformSampler : public Hd_RUZINO_PrimvarSampler {
   public:
    /// Constructor.
    /// \param name The name of the primvar.
    /// \param value The buffer data for the primvar.
    ...
    /// \param name The name of the primvar.
    /// \param value The buffer data for the primvar.
    Hd_RUZINO_UniformSampler(const TfToken& name, const VtValue& value)
        : _buffer(name, value),
          _sampler(_buffer)
    {
    }
...
/// \class Hd_RUZINO_TriangleVertexSampler
///
/// This class implements the Hd_RUZINO_PrimvarSampler interface for primvars
...
class Hd_RUZINO_TriangleVertexSampler : public Hd_RUZINO_PrimvarSampler {
   public:
    /// Constructor.
    /// \param name The name of the primvar.
    /// \param value The buffer data for the primvar.
...
/// \class Hd_RUZINO_TriangleFaceVaryingSampler
///
/// This class implements the Hd_RUZINO_PrimvarSampler interface for primvars
...
class Hd_RUZINO_TriangleFaceVaryingSampler : public Hd_RUZINO_PrimvarSampler {
   public:
...
/// \class Hd_RUZINO_SubdivVertexSampler
///
/// This class implements the Hd_RUZINO_PrimvarSampler interface for primvars
...
class Hd_RUZINO_SubdivVertexSampler : public Hd_RUZINO_PrimvarSampler {
   public:
    ...
    ~Hd_RUZINO_SubdivVertexSampler() override;
   ...
   private:
    ...
    RTCScene _meshScene;
    unsigned _meshId;
    Hd_RUZINO_RTCBufferAllocator* _allocator;
};
